// 공통 부서 상수 import
import { DEPARTMENT_COLORS as COMMON_DEPARTMENT_COLORS, normalizeDepartmentName } from '@/shared/constants/departments';

// 공통 부서 상수 재export
export { normalizeDepartmentName };

// 품질 이슈 전용 부서 목록 (증착/코팅/내부코팅 사용)
...
// 품질 이슈 전용 부서 색상 (증착/코팅/내부코팅 포함)
export const DEPARTMENT_COLORS = {
  ...COMMON_DEPARTMENT_COLORS,
