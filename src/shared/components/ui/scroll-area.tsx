...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      "flex touch-none select-none transition-[width,height] duration-200 ease-in-out group",
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-muted-foreground/20 group-hover:bg-muted-foreground/40 transition-colors duration-200 ease-in-out" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
))
